...
class Contacto 
{
    ...
    public:
        ...
        void setContacto(string em, string nom, int tel)  
        {
            nombre = nom;
            telefono = tel;
            email = em;
...
int main() 
{
        ...
        contacto->setContacto("cel@g.com", "Celes", 4324324);
        //cout<<contacto->getNombre()<<endl;

        Contacto* contacto2 = new Contacto();
        contacto2->setContacto("lu@g.com", "Luis", 9399929);
